...
<title>Search Route - Group ONE</title>
				...
				<div class="col-lg-12">
					...
					<div class="card">
						...
						<div>
							...
							<div
								style="float: left; width: 20%; margin-left: 2%; margin-bottom: 5px;">

								<h4>Search By Field</h4>
								<h5>
									<i class="bi bi-patch-exclamation"></i>Fill in only one field!
								</h5>
								<form
									action="${pageContext.request.contextPath}/route_search_by_id/">
									<label for="rId">Route ID</label> <input type="number" id="rId"
										placeholder="Example: 1234" class="form-control"
										autocomplete="off" name="routeId" required> <input
										type="submit" class="btn btn-secondary" value="Search"
										style="margin-top: 5px">
								</form>
								<form
									action="${pageContext.request.contextPath}/route_search_by_id/">
									<label style="margin-top: 5px" for="AlID">Airline ID</label> <input
										id="AlID" type="text" pattern="[0-9]*"
										placeholder="Example: 410" autocomplete="off" maxlength="6"
										class="form-control" name="airlineId"> <input
										type="submit" class="btn btn-secondary" value="Search"
										style="margin-top: 5px">
							...
							<div
								style="float: left; width: 20%; margin-left: 10%; margin-top: 68px;">
								<form
									action="${pageContext.request.contextPath}/route_search_by_id/">
									<label for="SApID">Source Airport Id</label> <input type="text"
										id="SApID" placeholder="Example: 6156" pattern="[0-9]*"
										maxlength="5" autocomplete="off" class="form-control"
										name="sourceAirportId"> <input type="submit"
										class="btn btn-secondary" value="Search"
										style="margin-top: 5px">
								</form>
								<form
									action="${pageContext.request.contextPath}/route_search_by_id/">
									<label style="margin-top: 5px" for="DApID">Destination
										Airport Id</label> <input type="text" placeholder="Example: 2922"
										id="DApID" pattern="[0-9]*" maxlength="5" class="form-control"
										autocomplete="off" name="destAirportId"> <input
										type="submit" class="btn btn-secondary" value="Search"
										style="margin-top: 5px">
								</form>
						...
						<nav aria-label="Page navigation example">
							<ul class="pagination justify-content-center">
								<li><a
									href="${pageContext.request.contextPath}/route_search/1"
									class="page-link"> First </a></li>

								<li><c:if test="${pageNo != 1}">
										<li class="page-item"><a class="page-link"
											href="${pageContext.request.contextPath}/route_search/${pageNo-1}"
													...
													<c:if test="${i-pageNo<5}">
														<c:if test="${pageNo-i<5}">
															<td
																...
																<a
																href="${pageContext.request.contextPath}/route_search/${i}">${i}</a>
															</td>
														</c:if>
													</c:if>
												</c:otherwise>
								...
								<li><a
									href="${pageContext.request.contextPath}/route_search/${totalPage}"
