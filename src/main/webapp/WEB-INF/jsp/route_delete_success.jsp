...
<head>
    ...
    <title>Route: Delete Successful - Group ONE</title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="route-forms-nav" class="nav-content collapse show"
                ...
                <li><a class="active" href="${pageContext.request.contextPath}/route_manage/1"> <i
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Show AND Manage Route Data</li>
                <li class="breadcrumb-item active">Route Data Removal Successful</li>
            </ol>
        </nav>
    </div>
    <!-- End Page Title -->
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card" style="text-align:center">
                    ...
                    <h2>Route Data Removal Success!</h2><br>
                    <h5>Click to return to previous page!</h5><br><br>
                    <a href="${pageContext.request.contextPath}/route_manage/1">
