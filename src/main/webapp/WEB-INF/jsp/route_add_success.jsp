...
<title>Route: Addition Successful - Group ONE</title>
		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Route Data Addition
						Successful</li>
				</ol>
			</nav>
		</div>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="card" style="text-align: center">
						...
						<h2>Route Data Addition Success!</h2>
						<br>
						<h5>Click to return to previous page!</h5>
						<br> <br> <a
							href="${pageContext.request.contextPath}/route_add_form">
