						...
						<div class="card-body">
							<div>
								...
								<div
									...
									<form
										...
										<label style="margin-top: 5px" for="AlID">Airline ID</label> <input
											type="text" pattern="[0-9]*" placeholder="Example: 410"
											autocomplete="off" maxlength="6" class="form-control"
											name="airlineId"> <input type="submit"
								...
								<div
									...
									<form
										action="${pageContext.request.contextPath}/route_search_by_id/">
										<label for="SApID">Source Airport Id</label> <input
											type="text" placeholder="Example: 6156" pattern="[0-9]*"
