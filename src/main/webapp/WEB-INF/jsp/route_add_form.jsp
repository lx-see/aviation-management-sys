...
<head>
    ...
    <title>Add Route - Group ONE</title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="route-forms-nav" class="nav-content collapse show"
                ...
                <li><a class="active" href="${pageContext.request.contextPath}/route_add_form"> <i
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Manage Route Data</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index">Home</a></li>
                <li class="breadcrumb-item">Route Module</li>
                <li class="breadcrumb-item">Manage Route Data</li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h1 class="card-title"
                            style="font-size: 60px; text-align: center">Add Route Form</h1>
                        <h5 class="card-title">New Route Detail</h5>
                        <!--New Route Details-->
                                ...
                                <div class="form-all">
                                    ...
                                    <div class="form-row">
                                        <div class="row mb-3  form-group">
                                            <label for="saId">Source Airport Id:</label> <input id="saId"
                                                                                                type="text"
                                                                                                placeholder="Example: 6156"
                                                                                                pattern="[0-9]*"
                                                                                                maxlength="5"
                                                                                                class="form-control"
                                        ...
                                        <div class="row mb-3 form-group form-right">
                                            <label for="saIATA/ICAO">Source Airport IATA/ICAO:</label> <input
                                                id="saIATA/ICAO"
                                    ...
                                    <div class="form-row">
                                        <div class="row mb-3 form-group">
                                            <label for="daId">Destination Airport Id:</label> <input id="daId"
                                                                                                     type="text"
                                                                                                     placeholder="Example: 2922"
                                                                                                     pattern="[0-9]*"
                                                                                                     maxlength="5"
                                                                                                     class="form-control"
                                                                                                     name="destAirportId"
                                    ...
                                    <!-- Equipments -->
                                    <div class="row mb-3">
                                        <label for="eq">Equipments:</label> <input type="text" id="eq"
                                                                                   oninput="this.value = this.value.toUpperCase()"
                                                                                   maxlength="4"
                                                                                   placeholder="Example: CR2"
                                                                                   class="form-control" name="equipment"
                                                                                   required>
                                    ...
                                    <div class="form-row">
                                        <div class="row mb-3 form-group">
                                            <label for="alId">Airline Id:</label> <input type="text" id="alId"
                                                                                         pattern="[0-9]*"
                                                                                         placeholder="Example: 410"
                                                                                         maxlength="6"
                                                                                         class="form-control"
                                        ...
                                        <!-- Airline IATA_ICAO -->
                                        <div class="row mb-3 form-group form-right">
                                            <label for="alIATA/ICAO">Airline IATA/ICAO:</label> <input id="alIATA/ICAO"
                                                                                                       type="text"
                                                                                                       oninput="this.value = this.value.toUpperCase()"
                                                                                                       placeholder="Example: 2B"
                                                                                                       maxlength="4"
                                                                                                       class="form-control"
                                                                                                       name="airlineiataIcao"
                                                                                                       required>
