...
<title>Route: Duplicate Record Found - Group ONE</title>
		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Duplicate Route Data Found</li>
				</ol>
			</nav>
		</div>
		<!-- End Page Title -->
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="card" style="text-align: center">
						...
						<h2>
							<i class="bi bi-patch-exclamation text-danger"></i> Duplicate
							Route Data Found!
						</h2>
						<br>
						<h5>Click to go to route management page!</h5>
						<br> <br> <a
