...
<title>Airport Login - Group One</title>
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="airport-forms-nav" class="nav-content collapse show"
					...
					<li><a class="active"
						href="${pageContext.request.contextPath}/airport_login"> <i
							class="bi bi-circle"></i><span>Verify Airport Entry</span>
					</a></li>
				</ul></li>
			<!-- End Airport Module -->
						...
						<div class="container">
							<div class="row">
								<div class="col-md-9 col-lg-8 mx-auto">
									...
									<!-- Sign In Form -->
									<form action="airport_managerLogin">
										<div class="form-floating mb-3">
											<input type="number" class="form-control" id="managerId"
												name="managerId" placeholder="Manager ID" required>
											<label for="managerId">Manager ID</label>
										</div>
										<div class="form-floating mb-3">
											<input type="password" class="form-control"
												id="managerPassword" name="managerPassword"
												placeholder="Password"> <label for="managerPassword"
